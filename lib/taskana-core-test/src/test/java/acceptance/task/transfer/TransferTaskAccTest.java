...
class TransferTaskAccTest {
  ...
  void setup() throws Exception {
    ...
    WorkbasketAccessItemBuilder.newWorkbasketAccessItem()
        ...
        .buildAndStore(workbasketService);
    WorkbasketAccessItemBuilder.newWorkbasketAccessItem()
        .workbasketId(defaultWorkbasketSummary7.getId())
        .accessId("teamlead-1")
        .permission(WorkbasketPermission.READ)
        .permission(WorkbasketPermission.READTASKS)
        .permission(WorkbasketPermission.APPEND)
  ...
  void should_TransferTaskToWorkbasket_When_WorkbasketIdIsProvided() throws Exception {
    ...
    taskService.transfer(task0.getId(), defaultWorkbasketSummary6.getId());
  ...
  void should_NotSetTheTransferFlag_When_SetTransferFlagNotRequested() throws Exception {
    taskService.transfer(task0.getId(), defaultWorkbasketSummary6.getId(), false);
